...
class PyGridtoolsCpp(PythonPackage):
    ...
    git="https://github.com/GridTools/gridtools"
    ...
    version("2.3.2",
            url=whl_url_prefix + "gridtools_cpp-2.3.2-py3-none-any.whl",
            sha256=
            "714752478647b1f886541f04d013a3e75b53b0741cc648db036b2358b3d9f6ff",
            expand=False)
