...
class Claw(CMakePackage):
    ...
    patch(
        ...
        sha256=
        '262799fde57cb32f1514db22a7757e994bd8b97090ce0a5f55249fd56d0e5c29',
        when='@:2.0.2%intel')
    ...
    patch(
        ...
        sha256=
        'a20427456560070e284ff44edb658383b635042be91d2ffbe7aeb7afbd8f02bc',
        when='@2.0.2%cce')
    ...
    def cmake_args(self):
        ...
        if self.version < Version('2.1'):
            args.append('-DOMNI_CONF_OPTION=--with-libxml2=%s' %
