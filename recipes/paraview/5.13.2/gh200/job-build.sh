...
VARIANT=
VERSION=5.13.2
SPACK_ENV_NAME="${IMAGE}-gh200--${VERSION}"
SRC=$HOME/src
STACKI_DIR=$SRC/alps-vcluster/stackinator
SYSTEM_DIR=$SRC/alps-vcluster/alps-cluster-config/daint
RECIPE_DIR=$HOME/src/alps-vcluster/alps-uenv/recipes/paraview/5.13.2/gh200
